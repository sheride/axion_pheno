                      ...
                      const std::map<std::string,std::string>& parameters)
{
  ...
  Manager()->AddHisto("10_sdETA", 100,-15.0,15.0);
  Manager()->AddHisto("11_M", 400,0.0,4000.0);
  Manager()->AddHisto("12_PT", 80,0.0,2000.0);
  Manager()->AddHisto("13_PT", 400,0.0,2000.0);
  Manager()->AddHisto("14_THT", 80,0.0,4000.0);
  Manager()->AddHisto("15_MET", 200,0.0,1000.0);
  Manager()->AddHisto("16_TET", 80,0.0,8000.0);
