                      ...
                      const std::map<std::string,std::string>& parameters)
{
  ...
  Manager()->AddCut("2_sdETA ( jets[1] jets[2] ) > 6.1 and M ( jets[1] jets[2] ) > 1750.0");
...
bool user::Execute(SampleFormat& sample, const EventFormat& event)
{
  ...
  //   * Cut: select sdETA ( jets[1] jets[2] ) > 6.1 and M ( jets[1] jets[2] ) > 1750.0, regions = []
  {
    ...
    if(!Manager()->ApplyCut(filter_global, "2_sdETA ( jets[1] jets[2] ) > 6.1 and M ( jets[1] jets[2] ) > 1750.0")) return true;
  }
