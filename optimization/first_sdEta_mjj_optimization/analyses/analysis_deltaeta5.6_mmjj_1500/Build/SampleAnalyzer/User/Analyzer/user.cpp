                      ...
                      const std::map<std::string,std::string>& parameters)
{
  ...
  Manager()->AddCut("2_( sdETA ( jets[1] jets[2] ) > 5.6 or sdETA ( jets[1] jets[2] ) < -5.6 ) and M ( jets[1] jets[2] ) > 1500.0");
...
bool user::Execute(SampleFormat& sample, const EventFormat& event)
{
  ...
  //   * Cut: select ( sdETA ( jets[1] jets[2] ) > 5.6 or sdETA ( jets[1] jets[2] ) < -5.6 ) and M ( jets[1] jets[2] ) > 1500.0, regions = []
  {
    ...
    if (matched) continue;
         ...
         if ((_P_jets_I1I_PTorderingfinalstate_REG_[ind[0]]->eta()-_P_jets_I2I_PTorderingfinalstate_REG_[ind[1]]->eta())>5.6) {filter[0]=true; break;}
      }
      }
    }
    }
    ...
    if (matched) continue;
         ...
         if ((_P_jets_I1I_PTorderingfinalstate_REG_[ind[0]]->eta()-_P_jets_I2I_PTorderingfinalstate_REG_[ind[1]]->eta())<-5.6) {filter[1]=true; break;}
      }
      }
    }
    }
    ...
    if(!Manager()->ApplyCut(filter_global, "2_( sdETA ( jets[1] jets[2] ) > 5.6 or sdETA ( jets[1] jets[2] ) < -5.6 ) and M ( jets[1] jets[2] ) > 1500.0")) return true;
  }
