                      ...
                      const std::map<std::string,std::string>& parameters)
{
  ...
  // ===== Selections ===== //
  Manager()->AddCut("1_( ( sdETA ( jets[1] jets[2] ) > 2.0 or sdETA ( jets[1] jets[2] ) < -2.0 ) and M ( jets[1] jets[2] ) > 750.0 ) and ( PT ( a[1] ) > 300.0 and M ( a[1] a[2] ) > 500.0 )");
  ...
  Manager()->AddHisto("8_M", 160,750.0,8000.0);
  Manager()->AddHisto("9_sdETA", 100,2.0,15.0);
  Manager()->AddHisto("10_M", 400,500.0,4000.0);
  Manager()->AddHisto("11_PT", 80,300.0,2000.0);
...
bool user::Execute(SampleFormat& sample, const EventFormat& event)
{
  ...
  //   * Cut: select ( ( sdETA ( jets[1] jets[2] ) > 2.0 or sdETA ( jets[1] jets[2] ) < -2.0 ) and M ( jets[1] jets[2] ) > 750.0 ) and ( PT ( a[1] ) > 300.0 and M ( a[1] a[2] ) > 500.0 ), regions = []
  {
    std::vector<MAbool> filter(5,false);
    {
    {
      MAuint32 ind[2];
    ...
    if (matched) continue;
         ...
         if ((_P_jets_I1I_PTorderingfinalstate_REG_[ind[0]]->eta()-_P_jets_I2I_PTorderingfinalstate_REG_[ind[1]]->eta())>2.0) {filter[0]=true; break;}
      }
      }
    }
    }
    ...
    if (matched) continue;
         ...
         if ((_P_jets_I1I_PTorderingfinalstate_REG_[ind[0]]->eta()-_P_jets_I2I_PTorderingfinalstate_REG_[ind[1]]->eta())<-2.0) {filter[1]=true; break;}
      }
      }
    }
    }
    ...
    if (matched) continue;
        ...
        if (q.m()>750.0) {filter[2]=true; break;}
      }
      }
    }
    }
    {
    {
      ...
      {
        if (_P_a_I1I_PTorderingfinalstate_REG_[ind[0]]->pt()>300.0) {filter[3]=true; break;}
      }
    }
    }
    {
    ...
    if (matched) continue;
        ...
        if (q.m()>500.0) {filter[4]=true; break;}
      }
      }
    }
    }
    MAbool filter_global = (((filter[0] || filter[1]) && filter[2]) && (filter[3] && filter[4]));
    if(!Manager()->ApplyCut(filter_global, "1_( ( sdETA ( jets[1] jets[2] ) > 2.0 or sdETA ( jets[1] jets[2] ) < -2.0 ) and M ( jets[1] jets[2] ) > 750.0 ) and ( PT ( a[1] ) > 300.0 and M ( a[1] a[2] ) > 500.0 )")) return true;
  }
