                      ...
                      const std::map<std::string,std::string>& parameters)
{
  ...
  Manager()->AddHisto("10_THT", 80,0.0,4000.0);
  Manager()->AddHisto("11_MET", 200,0.0,1000.0);
  Manager()->AddHisto("12_TET", 80,0.0,8000.0);
...
bool user::Execute(SampleFormat& sample, const EventFormat& event)
{
  ...
  //   * Plot: THT
  {
    Manager()->FillHisto("10_THT", PHYSICS->Transverse->EventTHT(event.mc()));
  }

  // Histogram number 11
  //   * Plot: MET
  {
    Manager()->FillHisto("11_MET", PHYSICS->Transverse->EventMET(event.mc()));
  }

  // Histogram number 12
  //   * Plot: TET
  {
    Manager()->FillHisto("12_TET", PHYSICS->Transverse->EventTET(event.mc()));
  }
