                      ...
                      const std::map<std::string,std::string>& parameters)
{
  ...
  // ===== Selections ===== //
  Manager()->AddCut("1_( ( sdETA ( jets[1] jets[2] ) > 3.1 or sdETA ( jets[1] jets[2] ) < -3.1 ) and M ( jets[1] jets[2] ) > 1000.0 ) and ( PT ( a[1] ) > 300.0 and M ( a[1] a[2] ) > 500.0 )");
...
bool user::Execute(SampleFormat& sample, const EventFormat& event)
{
  ...
  //   * Cut: select ( ( sdETA ( jets[1] jets[2] ) > 3.1 or sdETA ( jets[1] jets[2] ) < -3.1 ) and M ( jets[1] jets[2] ) > 1000.0 ) and ( PT ( a[1] ) > 300.0 and M ( a[1] a[2] ) > 500.0 ), regions = []
  {
    ...
    if (matched) continue;
         ...
         if ((_P_jets_I1I_PTorderingfinalstate_REG_[ind[0]]->eta()-_P_jets_I2I_PTorderingfinalstate_REG_[ind[1]]->eta())>3.1) {filter[0]=true; break;}
      }
      }
    }
    }
    ...
    if (matched) continue;
         ...
         if ((_P_jets_I1I_PTorderingfinalstate_REG_[ind[0]]->eta()-_P_jets_I2I_PTorderingfinalstate_REG_[ind[1]]->eta())<-3.1) {filter[1]=true; break;}
      }
      }
    }
    }
    ...
    if (matched) continue;
        ...
        if (q.m()>1000.0) {filter[2]=true; break;}
      }
      }
    }
    }
    ...
    if(!Manager()->ApplyCut(filter_global, "1_( ( sdETA ( jets[1] jets[2] ) > 3.1 or sdETA ( jets[1] jets[2] ) < -3.1 ) and M ( jets[1] jets[2] ) > 1000.0 ) and ( PT ( a[1] ) > 300.0 and M ( a[1] a[2] ) > 500.0 )")) return true;
  }
